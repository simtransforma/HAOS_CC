---
description: Delegação direta pro agente @email-marketer — Sequências de email, broadcasts, deliverability, automação
---
# /haos:email-marketer

Delegue esta demanda diretamente pro subagent **@email-marketer**.

**Identidade:** Sequências de email, broadcasts, deliverability, automação

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/email-marketer.md`)
