---
description: Delegação direta pro agente @funnel-architect — Arquitetura de funis — captura, nutrição, conversão, retenção
---
# /haos:funnel-architect

Delegue esta demanda diretamente pro subagent **@funnel-architect**.

**Identidade:** Arquitetura de funis — captura, nutrição, conversão, retenção

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/funnel-architect.md`)
