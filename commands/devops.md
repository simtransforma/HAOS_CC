---
description: Delegação direta pro agente @devops — Infra, deploy, CI/CD, monitoring, IaC
---
# /haos:devops

Delegue esta demanda diretamente pro subagent **@devops**.

**Identidade:** Infra, deploy, CI/CD, monitoring, IaC

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/devops.md`)
