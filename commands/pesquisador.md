---
description: Delegação direta pro agente @pesquisador — Pesquisa de mercado, concorrência, tendências, validação
---
# /haos:pesquisador

Delegue esta demanda diretamente pro subagent **@pesquisador**.

**Identidade:** Pesquisa de mercado, concorrência, tendências, validação

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/pesquisador.md`)
