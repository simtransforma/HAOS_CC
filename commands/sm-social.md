---
description: Delegação direta pro agente @sm-social — Social media management — Instagram, TikTok, YouTube, calendário
---
# /haos:sm-social

Delegue esta demanda diretamente pro subagent **@sm-social**.

**Identidade:** Social media management — Instagram, TikTok, YouTube, calendário

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/sm-social.md`)
