---
description: Delegação direta pro agente @videomaker — Roteiro, storyboard, produção de vídeo
---
# /haos:videomaker

Delegue esta demanda diretamente pro subagent **@videomaker**.

**Identidade:** Roteiro, storyboard, produção de vídeo

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/videomaker.md`)
