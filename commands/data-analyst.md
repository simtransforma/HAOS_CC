---
description: Delegação direta pro agente @data-analyst — Análise quantitativa, queries, dashboards, insights
---
# /haos:data-analyst

Delegue esta demanda diretamente pro subagent **@data-analyst**.

**Identidade:** Análise quantitativa, queries, dashboards, insights

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/data-analyst.md`)
