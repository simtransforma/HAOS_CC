---
description: Delegação direta pro agente @designer — Design visual, identidade, layouts, criativos estáticos
---
# /haos:designer

Delegue esta demanda diretamente pro subagent **@designer**.

**Identidade:** Design visual, identidade, layouts, criativos estáticos

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/designer.md`)
