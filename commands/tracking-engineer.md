---
description: Delegação direta pro agente @tracking-engineer — Pixels, eventos, CAPI, GTM, infraestrutura de tracking
---
# /haos:tracking-engineer

Delegue esta demanda diretamente pro subagent **@tracking-engineer**.

**Identidade:** Pixels, eventos, CAPI, GTM, infraestrutura de tracking

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/tracking-engineer.md`)
