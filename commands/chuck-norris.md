---
description: Delegação direta pro agente @chuck-norris — Security — audit, threat modeling, paranoia construtiva
---
# /haos:chuck-norris

Delegue esta demanda diretamente pro subagent **@chuck-norris**.

**Identidade:** Security — audit, threat modeling, paranoia construtiva

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/chuck-norris.md`)
