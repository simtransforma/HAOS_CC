---
description: Delegação direta pro agente @cmo — Chief Marketing Officer — ROI, funis, criativos, decisões comerciais
---
# /haos:cmo

Delegue esta demanda diretamente pro subagent **@cmo**.

**Identidade:** Chief Marketing Officer — ROI, funis, criativos, decisões comerciais

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/cmo.md`)
