---
description: Delegação direta pro agente @media-buyer — Operação tática de campanhas, ajustes diários, otimização
---
# /haos:media-buyer

Delegue esta demanda diretamente pro subagent **@media-buyer**.

**Identidade:** Operação tática de campanhas, ajustes diários, otimização

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/media-buyer.md`)
