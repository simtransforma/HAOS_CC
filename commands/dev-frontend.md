---
description: Delegação direta pro agente @dev-frontend — Implementação frontend, React/Next/Vue, performance, acessibilidade
---
# /haos:dev-frontend

Delegue esta demanda diretamente pro subagent **@dev-frontend**.

**Identidade:** Implementação frontend, React/Next/Vue, performance, acessibilidade

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/dev-frontend.md`)
