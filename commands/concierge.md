---
description: Delegação direta pro agente @concierge — Entry-point para visitantes/externos, triagem inicial
---
# /haos:concierge

Delegue esta demanda diretamente pro subagent **@concierge**.

**Identidade:** Entry-point para visitantes/externos, triagem inicial

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/concierge.md`)
