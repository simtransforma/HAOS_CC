---
description: Delegação direta pro agente @automation-engineer — Automações n8n/Zapier, integrações entre stacks
---
# /haos:automation-engineer

Delegue esta demanda diretamente pro subagent **@automation-engineer**.

**Identidade:** Automações n8n/Zapier, integrações entre stacks

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/automation-engineer.md`)
