---
description: Delegação direta pro agente @dev-backend — Backend, APIs, banco, autenticação, integrações
---
# /haos:dev-backend

Delegue esta demanda diretamente pro subagent **@dev-backend**.

**Identidade:** Backend, APIs, banco, autenticação, integrações

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/dev-backend.md`)
