---
description: Delegação direta pro agente @diretor-criativo — Direção criativa, aprovação de visual/copy, assina final
---
# /haos:diretor-criativo

Delegue esta demanda diretamente pro subagent **@diretor-criativo**.

**Identidade:** Direção criativa, aprovação de visual/copy, assina final

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/diretor-criativo.md`)
