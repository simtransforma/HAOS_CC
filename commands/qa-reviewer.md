---
description: Delegação direta pro agente @qa-reviewer — Quality assurance, testes, validação pré-deploy
---
# /haos:qa-reviewer

Delegue esta demanda diretamente pro subagent **@qa-reviewer**.

**Identidade:** Quality assurance, testes, validação pré-deploy

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/qa-reviewer.md`)
