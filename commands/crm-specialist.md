---
description: Delegação direta pro agente @crm-specialist — Operação de CRM, segmentação, lead scoring, follow-up
---
# /haos:crm-specialist

Delegue esta demanda diretamente pro subagent **@crm-specialist**.

**Identidade:** Operação de CRM, segmentação, lead scoring, follow-up

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/crm-specialist.md`)
