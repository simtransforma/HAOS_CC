---
description: Delegação direta pro agente @ux-researcher — Pesquisa UX, entrevistas, journey mapping, usabilidade
---
# /haos:ux-researcher

Delegue esta demanda diretamente pro subagent **@ux-researcher**.

**Identidade:** Pesquisa UX, entrevistas, journey mapping, usabilidade

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/ux-researcher.md`)
