---
description: Delegação direta pro agente @copy-specialist — Copywriting persuasivo, gatilhos mentais, headlines, CTAs
---
# /haos:copy-specialist

Delegue esta demanda diretamente pro subagent **@copy-specialist**.

**Identidade:** Copywriting persuasivo, gatilhos mentais, headlines, CTAs

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/copy-specialist.md`)
