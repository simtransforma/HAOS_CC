---
description: Delegação direta pro agente @bi-engineer — Pipeline de dados, ETL, modelagem dimensional, BI
---
# /haos:bi-engineer

Delegue esta demanda diretamente pro subagent **@bi-engineer**.

**Identidade:** Pipeline de dados, ETL, modelagem dimensional, BI

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/bi-engineer.md`)
