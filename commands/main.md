---
description: Delegação direta pro agente @main — Orquestrador principal — classifica, roteia, consolida
---
# /haos:main

Delegue esta demanda diretamente pro subagent **@main**.

**Identidade:** Orquestrador principal — classifica, roteia, consolida

## Como atuar

1. **Invoque o subagent** via tool Agent (carrega automaticamente `agents/main.md`)
